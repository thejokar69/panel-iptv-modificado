...
if(isset($_POST['submitU'])){
	$stmt = $db->prepare('UPDATE '.$table_name.' SET status=?, viewable_rate=?, message=? WHERE id=?');
	$stmt->bindParam(1, $_POST['status']);
	$stmt->bindParam(2, $_POST['viewable_rate']);
...
if (isset($_POST['submit'])){
	$stmt = $db->prepare("INSERT INTO $table_name (status, viewable_rate, message) VALUES (?, ?,?)");
	$stmt->bindParam(1, $_POST['status']);
	$stmt->bindParam(2, $_POST['viewable_rate']);
	$stmt->bindParam(3, $_POST['message']);
	$stmt->execute();
            ...
            <div class="card-body">
                <div class="card bg-primary text-white">
                    <div class="card-header card-header-warning">
                        <center>
                            <h2><i class="icon icon-bullhorn"></i> Add Ads</h2>
                        </center>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="col-12">
                            ...
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <label class="form-label " for="Description">viewable_rate</label>
                                        <input class="form-control" name="viewable_rate" placeholder="viewable_rate" type="text"/>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="card-body">
                        <div class="col-12">
                            ...
                            <form method="post">
                                <div class="form-group">
                                    <label class="form-label " for="status">status</label>
                                        <input class="form-control" name="status" placeholder="status" value="<?=$rowU['status'] ?>" type="text"/>
                                </div>
                                <div class="form-group">
                                    <label class="form-label " for="Description">Description</label>
                                        <input class="form-control" name="viewable_rate" placeholder="viewable_rate" value="<?=$rowU['viewable_rate'] ?>" type="text"/>
                               </div>
                                <div class="form-group">
                                    <label class="form-label " for="Description">Description</label>
                                        <input class="form-control" name="message" placeholder="message" value="<?=$rowU['message'] ?>" type="text"/>                                        
                                </div>
                                <input type="hidden" name="id" value="<?=$_GET['update'] ?>">
                                <input type="hidden" name="message"	value="<?php echo date("Y-m-d h:i:s")?>">
                                <div class="form-group">
                                    <center>
        ...
        <div class="col-md-12 mx-auto">
            <div class="card-body">
                <div class="card bg-primary text-white">
                    <div class="card-header card-header-warning">
                        <center>
                            <h2><i class="icon icon-commenting"></i> Current Adss</h2>
                        </center>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="col-12">
                        	<center>
	        					<a id="button" href="./<?php echo $base_file ?>?create" class="btn btn-info">New Ads</a>
	        				</center>
    					</div>
						<br>
